...
| `五行/skill.md` | **阴阳五行子网研究范式 Skill**：三级归约机制（T1定性→T2形式化→T3可计算）、中医/风水子网节点全图与跨子网连接、无矛盾三定律与冲突消解流程、节点注册规范与目录全图 |
| `五行/spum-黄帝内经.md` | 以 SPUM 五形框架重读黄帝内经：阴阳=V⁺/V⁻对偶、五脏=区域占优相位、经络=水形主干、治则=网络干预六策略、四诊拓扑读解、三魂七魄的图论定义 |
| `五行/spum-葬书.md` | 以 SPUM 五形框架重读葬书：龙=低σ脊线、穴=∇σ收敛点、砂=木形环、水=高介数链、向=链方向导数、可计算风水路线图 |
| `五行/spum-金匮要略.md` | 以 SPUM 五形框架翻译金匮要略方证：慢性杂病 S 向量亚稳态修复、金匮四步范式（破坏→重建→稳固）、15+方剂 ΔS 分解、方剂七型分类 |
| `五行/spum-伤寒论.md` | 以 SPUM 五形框架翻译伤寒论六经体系：外部 σ 塌陷波沿六经轨迹向内传播、S_火 追踪指标、12 方剂 ΔS 速查、误治的 SPUM 因果链 |
