...
**Skills 架构**：`.trae/rules/` 提供 10 个分层 Skill Rule 文件，`.trae/skills/` 提供独立知识库 Skill 目录（`wuxing-subnet`、`physics-subnet`、`rushidao-subnet`（M5 终审）与 `zhihu-knowledge`）。AI 按需加载。
